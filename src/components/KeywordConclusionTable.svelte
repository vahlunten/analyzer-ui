...
<main class="mt-2 max-w-fit">
    ...
    {:else}
        ...
        >
            ...
            >
                <thead
                    class="text-sm text-gray-700 uppercase bg-gray-50 text-right"
                >
                    <tr>
                ...
                <tbody class="text-center">
                    ...
                    {#if sources.htmlFound.length > 0 } <Icon src={VscCheck}/> {:else} <Icon src={VscClose}/> {/if}
                        ...
                        <td
                            class=" py-4 px-6 {sources.htmlFound.length > 0
                                ? 'bg-green-200'
                                : 'bg-red-200'}"
                        >
                            {#if sources.htmlFound.length > 0}
                                <Icon src={VscCheck} />
                            {:else}
                                <Icon src={VscClose} />
                            {/if}
                        ...
                        <td
                            class="py-4 px-6 {sources.jsonFound.length > 0
                                ? 'bg-green-200'
                                : 'bg-red-200'}"
                        >
                            {#if sources.jsonFound.length > 0}
                                <Icon src={VscCheck} />
                            {:else}
                                <Icon src={VscClose} />
                            {/if}
                        ...
                        <td
                            class=" py-4 px-6 {sources.schemaFound.length > 0
                                ? 'bg-green-200'
                                : 'bg-red-200'}"
                        >
                            {#if sources.schemaFound.length > 0}
                                <Icon src={VscCheck} />
                            {:else}
                                <Icon src={VscClose} />
                            {/if}
                        ...
                        <td
                            class=" py-4 px-6 {sources.metaFound.length > 0
                                ? 'bg-green-200'
                                : 'bg-red-200'}"
                        >
                            {#if sources.metaFound.length > 0}
                                <Icon src={VscCheck} />
                            {:else}
                                <Icon src={VscClose} />
                            {/if}
                        ...
                        <td
                            class=" py-4 px-6 {sources.xhrFound.length > 0
                                ? 'bg-green-200'
                                : 'bg-red-200'}"
                        >
                            {#if sources.xhrFound.length > 0}
                                <Icon src={VscCheck} />
                            {:else}
                                <Icon src={VscClose} />
                            {/if}
                        ...
                        <td
                            class=" py-4 px-6 {sources.windowFound.length > 0
                                ? 'bg-green-200'
                                : 'bg-red-200'}"
                        >
                            {#if sources.windowFound.length > 0}
                                <Icon src={VscCheck} />
                            {:else}
                                <Icon src={VscClose} />
                            {/if}
